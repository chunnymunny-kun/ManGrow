...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $imagePath = $_POST['current_image_path']; // Keep current image by default
    if (isset($_FILES['image_upload']) && $_FILES['image_upload']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!empty($_POST['current_image_path']) && file_exists($_POST['current_image_path'])) {
    ...
    $result = BadgeSystem::updateBadge(
        $_POST['badge_id'],
        $_POST['badge_name'],
        $_POST['description'],
        $_POST['instructions'],
