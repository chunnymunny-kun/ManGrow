            ...
            <div class="form-content">
                ...
                <form id="mangroveReportForm" action="uploadreport_m.php" method="POST" enctype="multipart/form-data" class="two-column-form">
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-group visual-selector">
                            <label class="section-label">
                                <i class="fas fa-tree"></i> Mangrove Species <em style="font-size: 0.9em; color: #666;">(Uri ng Bakawan)</em>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-map-marked-alt"></i> Mangrove Area <em style="font-size: 0.9em; color: #666;">(Lugar ng Bakawan)</em>
                            </label>
                        ...
                        <!-- City/Municipality Dropdown -->
                            <div class="form-group">
                                <label class="section-label">
                                    <i class="fas fa-city"></i> City/Municipality <em style="font-size: 0.9em; color: #666;">(Lungsod/Bayan)</em>
                                </label>
                            ...
                            <div class="form-group">
                                <label class="section-label">
                                    <i class="fas fa-map-pin"></i> Nearby Barangays <em style="font-size: 0.9em; color: #666;">(Mga Kalapit na Barangay)</em> (Select all that apply)
                                </label>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-map-marker-alt"></i> Location <em style="font-size: 0.9em; color: #666;">(Lokasyon)</em>
                            </label>
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="far fa-calendar-alt"></i> Date Recorded <em style="font-size: 0.9em; color: #666;">(Petsa ng Pagtatala)</em>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-heartbeat"></i> Status/Condition <em style="font-size: 0.9em; color: #666;">(Kalagayan)</em>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-ruler-combined"></i> Area Affected (m²) <em style="font-size: 0.9em; color: #666;">(Sukat ng Lugar na Tinutukan)</em>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-tree"></i> Forest Cover <em style="font-size: 0.9em; color: #666;">(Saklaw ng Kagubatan)</em>
                            </label>
                            <p style="font-size: 0.9em; color: #666; margin: 8px 0 16px 0;">
                                <i class="fas fa-info-circle"></i> Estimate what percentage of your plot area is covered by mangrove trees
                            </p>
                            <div class="visual-options">
                                <label class="option-card">
                                    <input type="radio" name="forest_cover" value="12.5" required>
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #fff8e1 0%, #ffe082 100%);">
                                            <i class="fas fa-seedling" style="font-size: 24px; color: #f57c00;"></i>
                                        </div>
                                        <span class="option-label">Sparse</span>
                                        <small class="option-sublabel">Manipis (0-25%)</small>
                                    </div>
                                </label>
                                <label class="option-card">
                                    <input type="radio" name="forest_cover" value="37.5">
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #c8e6c9 0%, #81c784 100%);">
                                            <i class="fas fa-tree" style="font-size: 24px; color: #388e3c;"></i>
                                        </div>
                                        <span class="option-label">Moderate</span>
                                        <small class="option-sublabel">Katamtaman (25-50%)</small>
                                    </div>
                                </label>
                                <label class="option-card">
                                    <input type="radio" name="forest_cover" value="62.5">
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #a5d6a7 0%, #66bb6a 100%);">
                                            <i class="fas fa-tree" style="font-size: 24px; color: #2e7d32;"></i>
                                            <i class="fas fa-tree" style="font-size: 18px; color: #1b5e20; margin-left: -8px;"></i>
                                        </div>
                                        <span class="option-label">Dense</span>
                                        <small class="option-sublabel">Makapal (50-75%)</small>
                                    </div>
                                </label>
                                <label class="option-card">
                                    <input type="radio" name="forest_cover" value="87.5">
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #81c784 0%, #43a047 100%);">
                                            <i class="fas fa-tree" style="font-size: 24px; color: #1b5e20;"></i>
                                            <i class="fas fa-tree" style="font-size: 20px; color: #2e7d32; margin-left: -10px;"></i>
                                            <i class="fas fa-tree" style="font-size: 18px; color: #388e3c; margin-left: -10px;"></i>
                                        </div>
                                        <span class="option-label">Very Dense</span>
                                        <small class="option-sublabel">Napakakapal (75-100%)</small>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-cloud-sun"></i> Canopy Density <em style="font-size: 0.9em; color: #666;">(Kapal ng Dahon sa Ibabaw)</em>
                            </label>
                            <p style="font-size: 0.9em; color: #666; margin: 8px 0 16px 0;">
                                <i class="fas fa-info-circle"></i> Look up - how much of the sky is covered by mangrove leaves/branches?
                            </p>
                            <div class="visual-options">
                                <label class="option-card">
                                    <input type="radio" name="canopy_density" value="12.5" required>
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #e1f5fe 0%, #81d4fa 100%);">
                                            <i class="fas fa-sun" style="font-size: 24px; color: #0277bd;"></i>
                                        </div>
                                        <span class="option-label">Open</span>
                                        <small class="option-sublabel">Bukas (0-25%)</small>
                                    </div>
                                </label>
                                <label class="option-card">
                                    <input type="radio" name="canopy_density" value="37.5">
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #b3e5fc 0%, #4fc3f7 100%);">
                                            <i class="fas fa-cloud-sun" style="font-size: 24px; color: #0288d1;"></i>
                                        </div>
                                        <span class="option-label">Partially Closed</span>
                                        <small class="option-sublabel">Bahagyang Sarado (25-50%)</small>
                                    </div>
                                </label>
                                <label class="option-card">
                                    <input type="radio" name="canopy_density" value="62.5">
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #81d4fa 0%, #29b6f6 100%);">
                                            <i class="fas fa-cloud" style="font-size: 24px; color: #01579b;"></i>
                                        </div>
                                        <span class="option-label">Mostly Closed</span>
                                        <small class="option-sublabel">Halos Sarado (50-75%)</small>
                                    </div>
                                </label>
                                <label class="option-card">
                                    <input type="radio" name="canopy_density" value="87.5">
                                    <div class="option-content">
                                        <div class="option-icon" style="background: linear-gradient(135deg, #4fc3f7 0%, #0288d1 100%);">
                                            <i class="fas fa-cloud" style="font-size: 24px; color: #01579b;"></i>
                                            <i class="fas fa-cloud" style="font-size: 18px; color: #0277bd; margin-left: -10px;"></i>
                                        </div>
                                        <span class="option-label">Fully Closed</span>
                                        <small class="option-sublabel">Lubos na Sarado (75-100%)</small>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-calculator"></i> Tree Count <em style="font-size: 0.9em; color: #666;">(Bilang ng Puno)</em>
                                <span style="font-weight: normal; font-size: 0.85em; color: #888;"> (Optional - for higher accuracy)</span>
                            </label>
                            <p style="font-size: 0.9em; color: #666; margin: 8px 0 12px 0;">
                                <i class="fas fa-info-circle"></i> If you counted the trees in your plot, enter the number here. This helps calculate tree density.
                            </p>
                            <input type="number" name="tree_count" min="0" class="form-input" placeholder="e.g., 45 trees" style="max-width: 300px;">
                        </div>

                        <!-- Image Upload -->
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-camera-retro"></i> Upload Images <em style="font-size: 0.9em; color: #666;">(Mga Larawan)</em> (Max 3)
                            </label>
                        ...
                        <div class="form-group">
                            <label class="section-label">
                                <i class="fas fa-comment-dots"></i> Remarks <em style="font-size: 0.9em; color: #666;">(Mga Puna)</em>
                            </label>
