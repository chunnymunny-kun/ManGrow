...
$tempacc_id = isset($_GET['id']) ? (int)$_GET['id'] : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $originalStmt = $connection->prepare("SELECT * FROM tempaccstbl WHERE tempacc_id = ?");
        $originalStmt->bind_param("i", $tempacc_id);
        ...
        $stmt = $connection->prepare("UPDATE tempaccstbl SET 
            firstname = ?, 
            lastname = ?, 
            email = ?, 
            personal_email = ?, 
...
// Fetch account data
$stmt = $connection->prepare("SELECT * FROM tempaccstbl WHERE tempacc_id = ?");
$stmt->bind_param("i", $tempacc_id);
$stmt->execute();
...
<head>
    ...
    <title>Edit Unverified Account</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css">
</head>
<body>
    <div class="container mt-5">
        <h2>Edit Unverified Account</h2>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="accessrole" required>
                        ...
                        <option value="Environmental Manager" <?= $account['accessrole'] === 'Environmental Manager' ? 'selected' : '' ?>>Environmental Manager</option>
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    value="<?= htmlspecialchars($account['password'])?>" required>
                </div>
