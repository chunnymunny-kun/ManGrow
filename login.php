<?php
session_start();
    if (isset($_GET['flash_status']) && isset($_GET['flash_msg'])) {
    $_SESSION['response'] = [
        'status' => $_GET['flash_status'],
        'msg' => $_GET['flash_msg']
    ];
...
<body>
    ...
    <div class="registerlinkbtn">
            <button type="button" name="regbtn" onclick="window.location.href='register.php';">Register</button>
    </div>
